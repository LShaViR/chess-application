...
const ChessBoard = ({ turn = WHITE }: ChessBoardProps) => {
  ...
  return (
    <div className="h-full mx-auto relative">
      <div className="h-full border border-dark-button relative bg-light-tile aspect-square grid grid-cols-8 grid-rows-8">
        {renderBoard()}
      </div>
    </div>
  );
